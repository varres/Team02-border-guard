...
privileged aspect SEADUSE_PUNKTController_Roo_Controller {
    ...
    public String SEADUSE_PUNKTController.createForm(Model uiModel) {
        ...
        if (SEADUS.countSEADUS() == 0) {
            dependencies.add(new String[]{"seadus", "seadus"});
        }
    ...
    public Collection<ISIKU_SEADUS_INTSIDENDIS> SEADUSE_PUNKTController.populateISIKU_SEADUS_INTSIDENDISs() {
